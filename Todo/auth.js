...
class AuthSystem {
    ...
    async handleLogin(e) {
        ...
        if (!user) {
            this.showError('loginEmailError', 'No account found with this email address');
            return;
        }
    ...
    validateSignup(name, email, password, confirmPassword) {
        ...
        if (!name || name.length < 2) {
            this.showError('signupNameError', 'Name must be at least 2 characters long');
            isValid = false;
        }
        ...
        if (!password) {
            ...
            this.showError('signupPasswordError', 'Password must be at least 6 characters long');
            isValid = false;
        }
    ...
    setCurrentUser(user) {
        ...
        localStorage.setItem('taskmaster_current_user', JSON.stringify(userSession));
